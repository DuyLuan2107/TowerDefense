...
(6, 1, 'Đạt 400 điểm rồi anh em ơi!', 'Chụp vội tấm hình khoe thành tích.', '2025-01-18 19:40:00'),
(7, 2, 'Tháp thường có mạnh không?', 'Mình nghĩ tỉ lệ sát thương theo giá khá ổn.', '2025-02-20 14:00:00'),
(8, 3, 'Bug? Quái đứng yên ở góc?', 'Ai gặp lỗi này chưa?', '2025-03-22 09:30:00'),
(9, 4, 'Tìm người giao lưu chiến thuật', 'Anh em vào thảo luận chiến thuật tại đây!', '2025-04-01 18:20:00'),
(10, 5, 'Điểm cao quá trời', 'Mãi đỉnh :)))', '2025-04-12 10:00:00'),

(11, 1, 'Xây tháp ở vị trí nào thì mạnh?', 'Mình thấy đầu đường không hiệu quả bằng giữa map.', '2025-01-28 20:40:00'),
(12, 2, 'Góp ý UI game', 'Nên thêm nút tăng tốc 2x.', '2025-02-25 09:15:00'),
(13, 3, 'Làm sao qua wave 3?', 'Mãi vẫn thua :(', '2025-03-30 22:00:00'),
(14, 4, 'Chia sẻ layout tháp siêu mạnh', 'Tối ưu hóa đường đi cực tốt.', '2025-04-09 11:55:00'),
(15, 5, 'Tối ưu FPS khi chơi trên laptop yếu', 'Tắt hiệu ứng sẽ mượt hơn.', '2025-04-18 17:25:00'),

(16, 1, 'Đạt kỷ lục 523 điểm!', 'Không tin luôn :)))', '2025-02-05 13:00:00'),
(17, 2, 'Nâng cấp tháp hay mua tháp mới?', 'Mọi người nghĩ sao?', '2025-02-28 15:10:00'),
(18, 3, 'Tháp 3 bá thật sự', 'Sát thương kinh khủng.', '2025-03-26 20:35:00'),
(19, 4, 'Mẹo qua wave khó', 'Chia sẻ cho anh em.', '2025-04-11 19:00:00'),
(20, 5, 'Game vui thật sự', 'Lâu rồi mới nghiện 1 game.', '2025-04-25 21:10:00'),

(21, 1, 'Tháp mạnh nhất là gì?', 'Theo mình thì tháp 3.', '2025-02-10 10:15:00'),
(22, 2, 'Lỗi âm thanh?', 'Không nghe tiếng bắn.', '2025-03-02 16:20:00'),
(23, 3, 'Cách farm vàng hiệu quả', 'Đặt tháp dồn quái.', '2025-03-28 13:40:00'),
(24, 4, 'Vừa thua wave 2', 'Buồn thật sự.', '2025-04-15 18:45:00'),
(25, 5, 'Góc khoe điểm', 'Anh em xem nè: 350 điểm.', '2025-04-27 09:50:00'),

(26, 1, 'Hardcore mode?', 'Admin thêm mode khó được không?', '2025-02-15 20:30:00'),
(27, 2, 'Anh em có mẹo gì chia sẻ không?', 'Mình mãi không lên nổi rank.', '2025-03-12 11:25:00'),
(28, 3, 'Nghi vấn bug sát thương', 'Quái mất máu hơi kỳ.', '2025-03-29 10:55:00'),
(29, 4, 'Map mới khi nào có?', 'Hóng update.', '2025-04-17 22:10:00'),
(30, 5, 'Cười xỉu với wave 3', 'Chạy như điên luôn.', '2025-04-30 14:30:00'),
...
(1,1,1,'Hay quá bạn!','2025-01-05 15:00:00'),
