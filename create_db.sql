...
(1, 1, 'Mẹo đạt 300+ điểm trong Tower Defense', 'Hãy đặt tháp ở các đoạn cua để tối ưu sát thương.', '2025-01-05 14:20:00'),
(2, 2, 'Vừa được 250 điểm!', 'Lần này quái ra nhanh quá nhưng vẫn thủ được.', '2025-02-16 10:45:00'),
(3, 3, 'Chiến thuật mới thử nghiệm', 'Ưu tiên nâng cấp tháp mạnh thay vì spam tháp thường.', '2025-03-15 16:10:00'),
(4, 4, 'Map này khó thật sự!', 'Wave 3 đúng kiểu đi vào lòng đất.', '2025-03-25 21:00:00'),
(5, 5, 'Hướng dẫn dành cho người mới', 'Cố gắng giữ vàng để nâng cấp thay vì mua tháp liên tục.', '2025-04-07 12:10:00'),

(6, 6, 'Đạt 400 điểm rồi anh em ơi!', 'Chụp vội tấm hình khoe thành tích.', '2025-01-18 19:40:00'),
(7, 7, 'Tháp thường có mạnh không?', 'Mình nghĩ tỉ lệ sát thương theo giá khá ổn.', '2025-02-20 14:00:00'),
(8, 8, 'Bug? Quái đứng yên ở góc?', 'Ai gặp lỗi này chưa?', '2025-03-22 09:30:00'),
(9, 9, 'Tìm người giao lưu chiến thuật', 'Anh em vào thảo luận chiến thuật tại đây!', '2025-04-01 18:20:00'),
(10, 10, 'Điểm cao quá trời', 'Mãi đỉnh :)))', '2025-04-12 10:00:00'),

(11, 11, 'Xây tháp ở vị trí nào thì mạnh?', 'Mình thấy đầu đường không hiệu quả bằng giữa map.', '2025-01-28 20:40:00'),
(12, 12, 'Góp ý UI game', 'Nên thêm nút tăng tốc 2x.', '2025-02-25 09:15:00'),
(13, 13, 'Làm sao qua wave 3?', 'Mãi vẫn thua :(', '2025-03-30 22:00:00'),
(14, 14, 'Chia sẻ layout tháp siêu mạnh', 'Tối ưu hóa đường đi cực tốt.', '2025-04-09 11:55:00'),
(15, 15, 'Tối ưu FPS khi chơi trên laptop yếu', 'Tắt hiệu ứng sẽ mượt hơn.', '2025-04-18 17:25:00'),

(16, 16, 'Đạt kỷ lục 523 điểm!', 'Không tin luôn :)))', '2025-02-05 13:00:00'),
(17, 17, 'Nâng cấp tháp hay mua tháp mới?', 'Mọi người nghĩ sao?', '2025-02-28 15:10:00'),
(18, 2, 'Tháp 3 bá thật sự', 'Sát thương kinh khủng.', '2025-03-26 20:35:00'),
(19, 1, 'Mẹo qua wave khó', 'Chia sẻ cho anh em.', '2025-04-11 19:00:00'),
(20, 4, 'Game vui thật sự', 'Lâu rồi mới nghiện 1 game.', '2025-04-25 21:10:00'),

(21, 5, 'Tháp mạnh nhất là gì?', 'Theo mình thì tháp 3.', '2025-02-10 10:15:00'),
(22, 7, 'Lỗi âm thanh?', 'Không nghe tiếng bắn.', '2025-03-02 16:20:00'),
(23, 8, 'Cách farm vàng hiệu quả', 'Đặt tháp dồn quái.', '2025-03-28 13:40:00'),
(24, 9, 'Vừa thua wave 2', 'Buồn thật sự.', '2025-04-15 18:45:00'),
(25, 10, 'Góc khoe điểm', 'Anh em xem nè: 350 điểm.', '2025-04-27 09:50:00'),

(26, 12, 'Hardcore mode?', 'Admin thêm mode khó được không?', '2025-02-15 20:30:00'),
(27, 13, 'Anh em có mẹo gì chia sẻ không?', 'Mình mãi không lên nổi rank.', '2025-03-12 11:25:00'),
(28, 1, 'Nghi vấn bug sát thương', 'Quái mất máu hơi kỳ.', '2025-03-29 10:55:00'),
(29, 5, 'Map mới khi nào có?', 'Hóng update.', '2025-04-17 22:10:00'),
(30, 8, 'Cười xỉu với wave 3', 'Chạy như điên luôn.', '2025-04-30 14:30:00'),

(31, 1, 'Chiến thuật nâng cấp hợp lý', 'Không nên nâng cấp liên tục.', '2025-02-18 12:10:00'),
(32, 2, '330 điểm rồi!', 'Lần sau cố 400.', '2025-03-05 09:45:00'),
(33, 3, 'Game hay quá trời', 'Nghiện rồi.', '2025-03-24 17:10:00'),
(34, 4, 'Top 10 server!!', 'Không tin nổi luôn.', '2025-04-20 20:20:00'),
(35, 5, 'Giảm lag thế nào?', 'Tắt animation nhé.', '2025-05-01 10:00:00');

INSERT INTO comments (id, post_id, user_id, content, created_at) VALUES
(1,1,5,'Hay quá bạn!','2025-01-05 15:00:00'),
(2,1,2,'Mình sẽ thử ngay.','2025-01-05 16:20:00'),
(3,1,3,'Chiến thuật hợp lý đấy.','2025-01-06 09:10:00'),
(4,2,4,'Điểm cao ghê!','2025-02-16 12:00:00'),
(5,2,5,'Chúc mừng bạn.','2025-02-16 14:50:00'),
(6,3,2,'Cũng đang bị lỗi này.','2025-03-15 18:00:00'),
(7,3,1,'Bạn thử reset wave xem.','2025-03-15 20:45:00'),
(8,4,3,'Chuẩn khó luôn.','2025-03-26 09:00:00'),
(9,4,2,'Map này hành mình hoài.','2025-03-26 11:10:00'),
(10,5,1,'Bài viết hữu ích cho newbie.','2025-04-07 13:30:00'),
(11,6,3,'400 điểm đỉnh thật!','2025-01-18 21:00:00'),
(12,6,4,'Quá khủng.','2025-01-19 09:10:00'),
(13,6,5,'Làm sao được vậy bạn?','2025-01-19 11:40:00'),
(14,7,1,'Tháp thường rẻ mà mạnh.','2025-02-20 15:20:00'),
(15,7,4,'Mình cũng thấy vậy.','2025-02-21 08:00:00'),
(16,8,2,'Mình chưa gặp lỗi này.','2025-03-22 11:15:00'),
(17,9,3,'Vào discord giao lưu nhé.','2025-04-01 20:00:00'),
(18,10,5,'Điểm đẹp quá.','2025-04-12 11:30:00'),
(19,11,4,'Đặt giữa map hiệu quả thiệt.','2025-01-29 13:00:00'),
(20,11,3,'Mình test thử rồi.','2025-01-29 15:40:00'),
(21,12,2,'Đồng ý, nên thêm speed x2.','2025-02-25 11:00:00'),
(22,13,1,'Wave 3 khó thật.','2025-03-30 23:10:00'),
(23,13,5,'Bạn cần thêm tháp mạnh.','2025-03-31 09:20:00'),
(24,14,4,'Cho xin layout bạn ơi.','2025-04-09 13:15:00'),
(25,15,1,'Cảm ơn tip.','2025-04-18 18:00:00'),
(26,15,2,'Laptop yếu cần nhẹ hơn.','2025-04-18 20:30:00'),
(27,16,3,'523 điểm quá khủng.','2025-02-05 15:00:00'),
(28,16,4,'Pro thật sự.','2025-02-05 17:40:00'),
(29,17,5,'Nên nâng cấp trước.','2025-02-28 17:00:00'),
(30,18,1,'Tháp 3 mạnh thiệt.','2025-03-26 22:00:00'),
(31,19,3,'Hay quá admin.','2025-04-12 09:10:00'),
(32,20,2,'Game vui thật.','2025-04-25 23:00:00');
